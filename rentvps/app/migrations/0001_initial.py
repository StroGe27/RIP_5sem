# Generated by Django 4.2.5 on 2024-01-10 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 10, 17, 16, 12, 32806, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ram', models.IntegerField(blank=True, null=True, verbose_name='Название')),
                ('ssd', models.IntegerField(blank=True, null=True, verbose_name='Название')),
                ('price', models.IntegerField(blank=True, null=True, verbose_name='Название')),
                ('status', models.IntegerField(choices=[(1, 'Действует'), (2, 'Удалена')], default=1, verbose_name='Статус')),
                ('image', models.ImageField(blank=True, default='tariffs/default.png', null=True, upload_to='tariffs', verbose_name='Картинка')),
            ],
            options={
                'verbose_name': 'Тариф',
